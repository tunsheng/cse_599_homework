    ...
    def __init__(self):
        self.network = layers.SequentialLayer(
            [
                ...
                layers.PReLULayer(1000, 0.001),
                layers.LinearLayer(1000, 100),
                # layers.PReLULayer(100, 0.001),
                layers.LinearLayer(100, 10),
                # layers.LinearLayer(28 * 28, 1000),
                # layers.ReLUNumbaLayer(),
                # layers.LinearLayer(1000, 784),
                # layers.ReLUNumbaLayer(),
                # layers.LinearLayer(784, 250),
                # layers.ReLUNumbaLayer(),
                # layers.LinearLayer(250, 100),
                # layers.ReLUNumbaLayer(),
                # layers.LinearLayer(100, 10),
            ]
        )
